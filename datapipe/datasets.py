...
from basicsr.data.CPDM_image_dataset import CPDMImageDataset
...
def create_dataset(dataset_config):
    ...
    elif dataset_config['type'] == 'CPDM':
        dataset = CPDMImageDataset(dataset_config['params'])
    elif dataset_config['type'] == 'RealCPDM':
